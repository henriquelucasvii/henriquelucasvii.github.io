    ...
    <section className="bg-[#1E1E1E] rounded-4xl p-10 flex flex-col md:flex-row items-center mx-4 gap-6 md:gap-12 md:mx-auto max-w-4xl m-3">
      ...
      <div className="flex flex-col gap-3 items-center md:items-start text-center md:text-left">
        ...
        <div className="flex gap-4">
          <button className="bg-[#D9D9D9] hover:bg-[#9A9A9A] text-black font-bold py-2 px-4 rounded cursor-pointer transition delay-150 duration-300 ease-in-out hover:-translate-y-0.5">Ver projetos</button>
          <button className="border border-[#D9D9D9] text-[#D9D9D9] font-bold py-2 px-4 rounded cursor-pointer transition delay-150 duration-200 ease-in-out hover:-translate-y-0.5">Falar comigo</button>
        </div>
      </div>
    </section>
  );
